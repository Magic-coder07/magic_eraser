...
class TextRemover extends StatefulWidget {
  final File? initialImage;
  const TextRemover({Key? key, this.initialImage}) : super(key: key);

  @override
  State<TextRemover> createState() => _TextRemoverState();
}

class _TextRemoverState extends State<TextRemover> {
  File? _image;
  ...
  Future<void> _process() async {
    ...
    try {
      final endpoint = '${BackendConfig.baseUrl}/remove_text';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Text Remover')),
      body: Padding(
